...
export interface Progress{version:2;activeSeconds:number;totalPracticeWords:number;bestWpm:number;bestScore:number;skillMap:SkillMap;history:QuizResult[]}
